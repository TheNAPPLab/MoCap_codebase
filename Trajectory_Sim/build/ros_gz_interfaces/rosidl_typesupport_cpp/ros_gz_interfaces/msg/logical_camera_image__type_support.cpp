...
static const _LogicalCameraImage_type_support_symbol_names_t _LogicalCameraImage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_gz_interfaces, msg, LogicalCameraImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_gz_interfaces, msg, LogicalCameraImage)),
  }
};
...
{
  return &::ros_gz_interfaces::msg::rosidl_typesupport_cpp::LogicalCameraImage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_gz_interfaces, msg, LogicalCameraImage)() {
  return get_message_type_support_handle<ros_gz_interfaces::msg::LogicalCameraImage>();
}
