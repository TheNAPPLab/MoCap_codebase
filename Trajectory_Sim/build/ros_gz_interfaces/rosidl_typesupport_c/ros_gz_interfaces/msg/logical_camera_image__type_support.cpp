...
static const _LogicalCameraImage_type_support_symbol_names_t _LogicalCameraImage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_gz_interfaces, msg, LogicalCameraImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_gz_interfaces, msg, LogicalCameraImage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_gz_interfaces, msg, LogicalCameraImage)() {
  return &::ros_gz_interfaces::msg::rosidl_typesupport_c::LogicalCameraImage_message_type_support_handle;
}
