...
class Metaclass_LogicalCameraImage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_gz_interfaces.msg import LogicalCameraImageModel
            if LogicalCameraImageModel.__class__._TYPE_SUPPORT is None:
                LogicalCameraImageModel.__class__.__import_type_support__()
...
class LogicalCameraImage(metaclass=Metaclass_LogicalCameraImage):
    ...
    _fields_and_field_types = {
        ...
        'model': 'sequence<ros_gz_interfaces/LogicalCameraImageModel>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Pose'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_gz_interfaces', 'msg'], 'LogicalCameraImageModel')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, LogicalCameraImageModel) for v in value) and
                 True), \
                "The 'model' field must be a set or sequence and each value of type 'LogicalCameraImageModel'"
        self._model = value
